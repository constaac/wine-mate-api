...
RSpec.describe WishListsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested wish_list as @wish_list" do
      wish_list = WishList.create! valid_attributes
      get :show, params: {id: wish_list.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested wish_list as @wish_list" do
      wish_list = WishList.create! valid_attributes
      get :edit, params: {id: wish_list.to_param}, session: valid_session
      expect(assigns(:wish_list)).to eq(wish_list)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new WishList" do
        expect {
          post :create, params: {wish_list: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved wish_list as @wish_list" do
        post :create, params: {wish_list: invalid_attributes}, session: valid_session
        expect(assigns(:wish_list)).to be_a_new(WishList)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested wish_list" do
        wish_list = WishList.create! valid_attributes
        put :update, params: {id: wish_list.to_param, wish_list: new_attributes}, session: valid_session
        wish_list.reload
      ...
      it "assigns the requested wish_list as @wish_list" do
        wish_list = WishList.create! valid_attributes
        put :update, params: {id: wish_list.to_param, wish_list: valid_attributes}, session: valid_session
        expect(assigns(:wish_list)).to eq(wish_list)
      end
    ...
    context "with invalid params" do
      it "assigns the wish_list as @wish_list" do
        wish_list = WishList.create! valid_attributes
        put :update, params: {id: wish_list.to_param, wish_list: invalid_attributes}, session: valid_session
        expect(assigns(:wish_list)).to eq(wish_list)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested wish_list" do
      wish_list = WishList.create! valid_attributes
      expect {
        delete :destroy, params: {id: wish_list.to_param}, session: valid_session
      }.to change(WishList, :count).by(-1)
    end
